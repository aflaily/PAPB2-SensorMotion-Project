...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    //utk menampung data dari sensor accelerometer dan magnetometer
    ...
    //kalo ada perubahan data yg dipanggil adl eventListener onSensorChanged
    @Override
    public void onSensorChanged(SensorEvent sensorEvent) {
        //memastikan tipe sensor dgn sensorType
